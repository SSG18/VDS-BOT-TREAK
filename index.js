...
async function finalizeRegularVote(proposalId) {
  ...
  // Get vote counts
  const voteCounts = await db.getVoteCounts(proposalId);
  ...
  // Получаем информацию о заседании ТОЛЬКО для этой палаты
  ...
  // Обновляем сообщение с хронологией
